 ...
 */
public class AbstractPQLBotEx<F extends IFlow<N>, N extends INode, P extends IPlace, T extends ITransition, M extends IMarking<F,N,P,T>> 
extends Thread
implements IPQLBotHeartBeat {
	 ...
	 */
	public AbstractPQLBotEx(Connection con, String botName, IPQLIndex<F,N,P,T,M> index, IModelChecker<F,N,P,T,M> mc, IndexType indexType, long indexTime, long sleepTime) throws ClassNotFoundException, NameInUseException, SQLException {
		this.connection = con;
